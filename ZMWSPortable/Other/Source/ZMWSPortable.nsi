...
; License : GPL
; Ce script permet de créer le lanceur de ZMWSPortable.
; Compiler: NSIS (http://www.nullsoft.com).
; Require plugins: newadvsplash
; $id=ZMWSPortable.nsi $date=2011-04-02
; ----------------------------------------------------
...
!define DEFAULTEXE "ZazouMiniWebServerMonitor.exe"
!define DEFAULTAPPDIR "App\ZMWS"
